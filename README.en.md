...
| Repo | Stars | Description |
| --- | --- | --- |
| [huggingface/agents-course](https://github.com/huggingface/agents-course) | ⭐ 31.3k | 🟢 Beginner · **Hugging Face Agents Course** — the most popular agent intro course (free, open-source textbook). |
...
| [adamwlarson/ai-book-writer](https://github.com/adamwlarson/ai-book-writer) | ⭐ 392 | 🟢 Beginner · An AutoGen experiment: can an AI agent write a whole book on its own? |

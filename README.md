...
> 数据抓取时间：2026-08-30 · Star 数由 GitHub Actions 每日自动更新，按热门度排序。
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | ⭐ 43.3k | 🟢 入门 · **《深入理解 AI Agent：设计原理与工程实践》**（李博杰 著）开源主仓库：全书正文、编译版 PDF 与按章配套代码。目前最热的中文 Agent 书籍 |
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | ⭐ 13.5k | 🟡 进阶 · **DeepSeek Harness 插件精选清单**：dsh 生态插件大全（类 awesome 列表） |
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 244.1k | 🟡 进阶 · **ECC: Agent Harness 性能优化系统**：Skills / Instincts / Memory / Security，服务 Claude Code、Codex、OpenCode 等 |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 203.2k | 🟡 进阶 · **DeepSeek Harness**：「万物皆插件」的官方开源 Agent Harness，上线两周即破 20 万 Star |
...
| [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) | ⭐ 21.8k | 🟢 入门 · **DSH Desktop**：DeepSeek Harness 插件生态的现代化桌面端，「桌面本身也是插件」 |

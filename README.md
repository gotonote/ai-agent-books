...
> 数据抓取时间：2026-08-25 · Star 数由 GitHub Actions 每日自动更新，按热门度排序。
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | ⭐ 41.7k | 🟢 入门 · **《深入理解 AI Agent：设计原理与工程实践》**（李博杰 著）开源主仓库：全书正文、编译版 PDF 与按章配套代码。目前最热的中文 Agent 书籍 |
...
| # | 仓库 | Star | 一句话 |
| --- | --- | --- | --- |
| 1 | [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | ⭐ 41.7k | 深入理解 AI Agent（李博杰） |
